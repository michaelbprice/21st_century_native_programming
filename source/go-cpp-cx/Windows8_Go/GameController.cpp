...
GameController::GameController (IPlayer & one, IPlayer & two)
  ...
  , m_playerTwo(two)
{
    LOG_FUNCTION(wcout, L"GameController::GameController");
...
{
    LOG_FUNCTION(wcout, L"GameController::doGameLoop");
    ...
    while (passCount < 2)
    {
        ...
        if (currentPlayer.hasStones())
        {
            ...
            gLogger.log(LogLevel::kNone, wcout, L"Player ", currentPlayer.getName(),
...
{
    LOG_FUNCTION(wcout, L"GameController::doScoring");
...
{
    LOG_FUNCTION(wcout, L"GameController::start");
    ...
    //
    gLogger.log(LogLevel::kMedium, wcout, L"Players choosing names");
    ...
    //
    gLogger.log(LogLevel::kMedium, wcout, L"Player 1 picking color");
